...
if __name__ == '__main__':
    ...
    # os.system("xdg-open image2.png")

    # import ffmpeg

    # ffmpeg.input("*.png", pattern_type="glob", framerate=25).output("movie.mp4").run()
    ...
    # video = ImageSequenceClip(image_files, fps=1, durations=[1, 10])
    # video.write_videofile("image.mp4")
    # os.system("vlc image.mp4")